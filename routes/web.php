...
//Route::get('/', function () {
//    return redirect()->away('https://saivasbizconnect.com/');
//})->name('welcome');

Route::get('/about', function () {
    return redirect()->away('https://saivasbizconnect.com/standard-fireworks-online-about-us/');
})->name('about');

Route::get('/shop', function () {
    return redirect()->away('https://saivasbizconnect.com/shop-diwali-fireworks-online/');
})->name('shop');

Route::get('/contact', function () {
    return redirect()->away('https://saivasbizconnect.com/fireworks-sellers-contact-us/');
})->name('contact');
...
Route::get('admin1', [CategoryController::class, 'index'])->name('admin1.categories.index');
