<footer class="bg-f5f5f5 text-black py-12 border-t border-gray-300 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] mt-4">
<div class="w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <!-- Logo & About -->
        <div>
            <img src="{{ asset('logo/logo.png') }}" alt="NCW Logo" class="w-40 mb-4">
            <p class="text-sm text-black leading-relaxed space-y-1">
                <span class="block font-semibold text-black mb-1">Niyaa Crackers World (NCW)</span>
        ...
        <!-- Contact -->
        <div>
            <h3 class="font-bold text-lg mb-4 text-black">Contact</h3>
            <p class="flex items-start gap-2 mb-2 text-black leading-relaxed hover:text-red-500 transition">
                <span><i class="fa-solid fa-location-dot text-red-500 text-lg"></i></span>
                S.no:358/2c, D.no:3/1336, Paraipatti, Viswanatham Village, Taluk: Sivakasi, District: Virudhunagar – Tamilnadu.
            </p>
            <p class="flex items-center gap-2 mb-2 text-black hover:text-red-500 transition">
                <span><i class="fa-solid fa-phone text-red-500 text-lg"></i></span>
                +91 99622 01775
            </p>
            <p class="flex items-center gap-2 mb-4 text-black hover:text-red-500 transition">
                <span><i class="fa-solid fa-envelope text-red-500 text-lg"></i></span>
                niyaacrackersworld@gmail.com
            </p>
